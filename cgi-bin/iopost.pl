...
#
# NOTE: $no_content = 1 - will disable redirection to different web page !!!
#

# MODIFICATIONS
# -------------
# 13/01/2020 $gmt_offset variable added to adjust for sender's time zone
...
BEGIN
{
  ...
  $postmaster        = 'postmaster@scifi4ever.com';
  @referers          = qw(scifi4ever.com www.scifi4ever.com sf4e.com www.sf4e.com);
  @allow_mail_to     = qw(mailbox@scifi4ever.com);
  @recipients        = ();
  %recipient_alias   = ('default' => 'mailbox@scifi4ever.com');
...
$self->{FormConfig}{realname} ($self->{FormConfig}{email}) on $date GMT
$dashes
END
}
